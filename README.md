...
## Roadmap
* **Bare-Metal ESP32 Port:** Migrating the core VFS logic to run natively on the ESP32 using the ESP-IDF framework, replacing standard I/O with UART communication.[X]
